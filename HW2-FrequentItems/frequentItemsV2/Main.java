...
public class Main {
	...
	public static void main(String[] args) throws FileNotFoundException {
		double s = 0.01;
		double c = 0.5;
		String data_path = "d:/data/T10I4D100K.dat";
		...
		HashMap<HashSet<Integer>, Integer> ThirdItemMap=new Construct().generate(secfreItemMap, 3);
		HashMap<HashSet<Integer>, Integer> ThirdfreItemMap=new filter().filte(s, ThirdItemMap, basketSet);
		System.out.println("frequent tripletons (size: " + ThirdfreItemMap.size() + "):");
		System.out.println(ThirdfreItemMap);
		System.out.println("------ third pass done! ------");
		System.out.println();
		
		System.out.println("------ Finding associated itemSet ------");
		List <assoSet> assoItemMap=new Association().Confidence(s, c, freItemMap, secfreItemMap, ThirdfreItemMap);		
		System.out.println("Associated set (size: " + assoItemMap.size() + "):");
		for(assoSet set:assoItemMap){
